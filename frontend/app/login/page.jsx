    ...
    <div className="login-bg">
      ...
      <div className="login-card">
        ...
        <div className="login-logo">
          ...
          <span className="login-logo-text">MeetYou<span>Live</span></span>
        </div>
      ...
      <style jsx>{`
        ...
        .login-bg {
          ...
          background:
            radial-gradient(ellipse at 65% 10%, rgba(139,92,246,0.2) 0%, transparent 50%),
            radial-gradient(ellipse at 10% 90%, rgba(224,64,251,0.15) 0%, transparent 50%),
            radial-gradient(ellipse at 90% 70%, rgba(34,211,238,0.08) 0%, transparent 40%),
            #060411;
          padding: 2rem 1rem;
          position: relative;
          overflow: hidden;
        ...
        .particle-7  { left: 68%; top: 70%; animation-delay: 0.9s; animation-duration: 10s; background: rgba(34,211,238,0.4); width: 4px; height: 4px; }
        ...
        .particle-11 { left: 18%; top: 42%; animation-delay: 5s;   animation-duration: 9s; background: rgba(244,114,182,0.5); }
        ...
        .particle-16 { left: 7%;  top: 30%; animation-delay: 6s;   animation-duration: 10s; background: rgba(34,211,238,0.5); }
